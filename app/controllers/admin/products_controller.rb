class Admin::ProductsController < AdminController
  ...
  def up
    ...
    redirect_to admin_store_category_products_url(@category)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @product.save_with_attachments
        ...
        format.html { redirect_to admin_store_category_product_url(@category, @product)  }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_store_category_products_url(@category) }
      format.xml  { head :ok }
    end
  end
end
