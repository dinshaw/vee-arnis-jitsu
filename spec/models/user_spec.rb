...
protected
  def create_user(select_options = {})
    record = User.new({ :first_name => "First", :last_name => "Last", :login => 'quire', :email => 'quire@example.com', :password => 'quire69', :password_confirmation => 'quire69' }.merge(select_options))
