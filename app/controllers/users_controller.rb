class UsersController < ApplicationController
  ...
  skip_before_filter :login_required, :only => [:forgot_password, :reset_password, :activate, :create, :activate]
  
  ssl_required :registration, :activate, :suspend, :unsuspend, :destroy, :purge, :forgot_password, :reset_password
